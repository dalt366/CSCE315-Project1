...
private:
	...
	*/
	...
	bool recordMatchesArgs(vector<string> attributeNames, vector<Table::TYPE> attributeTypes, Record record, string args);
	bool expression(vector<string> attributeNames, vector<Table::TYPE> attributeTypes, Record record, string args);
	string getAttributeInArgs(string term);
	Table::TYPE getAttributeType(vector<string> attributeNames, vector<Table::TYPE> attributeTypes, string attribute);
	string term(vector<string> attributeNames, Record record, string term);
};
